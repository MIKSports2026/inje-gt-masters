...
export default function EntryForm({ isOpen, rounds, initialRoundNumber }: Props) {
  ...
  return (
    <div className="ef-card">
        ...
        <div className="ef-step">
          ...
          <div className="form-agreements">
            <label className="ef-checkbox">
              ...
              <button type="button" onClick={(e) => { e.preventDefault(); setShowPledge(true) }} style={{ background: 'none', border: '1px solid var(--primary-red, #E60023)', color: 'var(--primary-red, #E60023)', padding: '2px 10px', fontSize: '.75rem', fontFamily: "var(--font-heading, 'Oswald')", letterSpacing: '1px', cursor: 'pointer', marginLeft: 8 }}>규정 보기</button>
            </label>
            <label className="ef-checkbox">
      ...
      {/* 참가서약서 모달 */}
      {showPledge && (
        <div className="pledge-overlay" onClick={() => setShowPledge(false)}>
          <div className="pledge-modal" onClick={e => e.stopPropagation()}>
            <div className="pledge-modal__head">
              ...
              <button type="button" onClick={() => setShowPledge(false)} className="pledge-modal__close">✕</button>
            </div>
            ...
            <div className="pledge-modal__foot">
              <button type="button" onClick={() => { set('agreedRules', true); setShowPledge(false) }} className="ef-btn-submit" style={{ width: '100%' }}>
                동의합니다
              </button>
            </div>
          </div>
